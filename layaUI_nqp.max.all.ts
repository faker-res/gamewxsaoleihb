...
module ui.nqp.game_ui.wxsaoleihb.component {
    export class WXSaoLei_getUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{"width":720,"height":43},"child":[{"type":"Box","props":{"var":"box_main","centerY":0,"centerX":0},"child":[{"type":"Image","props":{"y":0,"x":0,"var":"img_di","skin":"tongyong_ui/game_ui/tongyong/general/tu_k3.png","sizeGrid":"10,10,10,10","alpha":0.3}},{"type":"Label","props":{"var":"lb_info","text":"玩家领取了您的红包,获得0.13元,中雷1赔付3.60元","fontSize":20,"color":"#000000","centerY":0,"centerX":0,"bold":true,"align":"center"}}]}]};
        constructor(){ super()}
        createChildren():void {
